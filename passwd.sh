...
curl -X POST "http://localhost:5601/api/spaces/space" -u elastic:$(cat /opt/elk/elastic) -H 'kbn-xsrf: true' -H 'Content-Type: application/json' -d'{"id": "linux-servers","name": "Linux Servers","description" : "This is the Linux Servers space","color": "#aabbcc","initials": "LS"}'
